        ...
        echo '
            <div class="col-12 col-md-4 m-auto">
                    <div class="card mb-3 fondo">
                        <img class="card-img-top" src="Recursos/img/dioses/' . $nombre . '.jpg" alt="Card image cap">
                        <div class="card-body border-top">
                            <h2 class="card-title text-black">' . $id . ' | ' . $nombre . '</h2>
                            <hr>
                            <p class="card-text font-x-large"><img src="Recursos/img/pantheon/' . $panteon . '.png" alt=""
                                                                   class="pantheon">' . $panteon . '
                            </p>
                            <p class="card-text font-x-large"><img src="Recursos/img/tipo/' . $rol . '.png" alt=""
                                                                   class="pantheon">' . $rol . '
                            </p>
