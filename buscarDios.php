        ...
        <section class="text-center container-buscador borde">
            <form class="m-auto buscador" action="buscarDios.php" method="get">
                <input class="mr-sm-2 p-2" type="search" name="buscar"
                       placeholder="Buscar nuevamente un dios por id, nombre, rol o pantheon"
                       aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-0" name="button" type="submit">Buscar</button>
            </form>
        </section>
        <section class="p-4 text-center">
            <h3 class="text-center text-white border-bottom busqueda">Has buscado un dios por el siguente filtro :
        ...
        <section class="p-1 container">
            <article class="row">
                ...
                if ($_SESSION["logeado"] == 1) {
                    ...
                    busquedaDiosVistaUsuario($conexion, $boton, $search);
                }
                ?>
            </article>
        </section>
